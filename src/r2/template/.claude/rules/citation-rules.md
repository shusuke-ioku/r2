...
- **Literature context:** Always consult `library/lit/` before writing prose that engages the literature. Start with `00_overview.md`.
- **Background docs:** All background research goes in `library/`. Do not scatter elsewhere.
