...
- **Literature context:** Always consult `notes/lit/` before writing prose that engages the literature. Start with `00_overview.md`.
- **Background docs:** All background research goes in `notes/`. Do not scatter elsewhere.
